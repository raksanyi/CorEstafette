...
var Communicator = /** @class */ (function () {
    ...
    Communicator.prototype.startConnection = function () {
    ...
    Communicator.prototype.sendMessage = function (user, message) {
    ...
    Communicator.prototype.subscribe = function (user, topic) {
    ...
    Communicator.prototype.unsubscribe = function (user, topic) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
